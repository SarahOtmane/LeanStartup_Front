...
const Section4: React.FC = () => {
    ...
    return (
        <section className='section4'>
            ...
            <p className='text-align-center'>Ne manque aucune opportunité pour booster ta recherche d’alternance et ta carrière. <br></br> Inscris-toi à notre newsletter et reçois directement dans ta boîte mail</p>
